...
public class LaserSound implements ITickableSound {
    ...
    public LaserSound(ResourceLocation resource, float volume, float pitch, Vec3i pos, SoundCategory category, int ttl) {
        this(resource, volume, pitch, pos.getX(), pos.getY(), pos.getZ(), category, ttl);
    }

    public LaserSound(ResourceLocation resource, float volume, float pitch, SoundCategory category, int ttl) {
        this(resource, volume, pitch, 0F, 0F, 0F, category, ttl);
    }

    public LaserSound(ResourceLocation resource, float volume, float pitch, int ttl) {
        this(resource, volume, pitch, SoundCategory.MASTER, ttl);
    }

    public LaserSound(ResourceLocation resource, int ttl) {
